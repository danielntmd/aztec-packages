...
class DeviceContext {
  public:
    ...
    void ensure_srs_uploaded(const bn254::affine_g1_t* srs_points, size_t num_points);
    ...
    [[nodiscard]] std::span<const bn254::affine_g1_t> srs_points() const noexcept
    {
        return { srs_points_.data(), srs_size_ };
    }
    [[nodiscard]] void* temp_storage() noexcept { return temp_storage_.data(); }
    [[nodiscard]] size_t temp_storage_size() const noexcept { return temp_storage_.size(); }

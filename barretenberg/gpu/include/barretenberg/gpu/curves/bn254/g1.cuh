...
BB_GPU_HD inline void batch_normalize(jacobian_g1_t* points, const size_t num_points)
{
    // Minimal correctness implementation for phase 1. MSM can replace this with
    // a parallel prefix/batch inversion strategy once the primitive layer is stable.
